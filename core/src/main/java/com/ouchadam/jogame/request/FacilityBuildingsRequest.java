...
class FacilityBuildingsRequest extends JogameApiRequest<List<Buildable>> {

    private final Parser<List<Buildable>> buildableParser;

    FacilityBuildingsRequest(SessionValidator sessionValidator, String planet, Parser<List<Buildable>> buildableParser) {
